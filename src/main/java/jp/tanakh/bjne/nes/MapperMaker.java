...
public class MapperMaker {
	...
	public static Mapper makeMapper(int num, Nes n) {
		...
		try {
			...
			classes = new Class<?>[] {
					jp.tanakh.bjne.nes.mapper.CNROM.class,
					jp.tanakh.bjne.nes.mapper.UNROM.class,
					jp.tanakh.bjne.nes.mapper.MMC1.class,
					jp.tanakh.bjne.nes.mapper.MMC3.class,
					jp.tanakh.bjne.nes.mapper.VRC6.class,
					jp.tanakh.bjne.nes.mapper.NullMapper.class
			};
